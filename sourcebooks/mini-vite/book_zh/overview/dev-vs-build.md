...
| 环境 | 核心目标 | Vite 采用的策略 | 优点 | 缺点 |
| :--- | :--- | :--- | :--- | :--- |
| **开发 (Dev)** | 极速的反馈循环、强大的调试能力 | 原生 ESM 开发服务器 | 冷启动快如闪电、HMR 瞬时完成 | 页面初次加载时网络请求多、依赖预构建过程复杂 |
| **构建 (Build)** | 最佳的加载性能、更小的代码体积 | 基于 Rollup 的打包 | 请求次数少、代码经过极致优化、Tree-shaking 效果好 | 构建过程相对较慢 |
